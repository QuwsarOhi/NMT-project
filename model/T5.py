...
class T5(Module):
    ...
    def forward(self, input:List[str], loss:bool=False) -> Tensor:
...
if __name__ == '__main__':
    ...
    model = T5(max_seq_len=32, eos_idx=1, padding_idx=0, beam_size=1)

    inputs = ["translate English to German: Thank you so much, Chris.",
